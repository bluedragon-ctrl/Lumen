@echo off
REM Launch the Lumen room editor and open it in the default browser.
REM Double-click this file, or run it from a terminal. Ctrl+C to stop.

cd /d "%~dp0..\.."

echo Starting the Lumen room editor on http://localhost:3940 ...
start "" http://localhost:3940
node "tools\room-editor\room-editor.js"
